...
function processarFichaUser()
{
    ...
    $anamneseUsoMedicacao = isset($_POST['anamnseseUsoMedicacao']) ? implode(", ", (array)$_POST['anamneseUsoMedicacao']) : '';
    ...
    $anamneseAlergico = isset($_POST['anamnseseAlergico']) ? implode(", ", (array)$_POST['anamneseAlergico']) : '';
