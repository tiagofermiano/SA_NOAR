...
function processarFormulario() {
    ...
    $cinematicaDisturbioComportamento = implode(", ", $_POST['disturbio']);
    $cinematicaEncontradoCapacete = implode(", ", $_POST['encontradoCapacete']);
    $cinematicaEncontradoCinto = implode(", ", $_POST['encontradoCinto']);
    $cinematicaParabrisaAvariado = implode(", ", $_POST['parabrisaAvariado']);
    $cinematicaCaminhandoCena = implode(", ", $_POST['caminhandoCena']);
    $cinematicaPainelAvariado = implode(", ", $_POST['painelAvariado']);
    $cinematicaVolanteTorcido = implode(", ", $_POST['volanteTorcido']);
