...
<body>
  ...
  <header>
    ...
    <div class="perfil">
        <a href="telaperfil_admin.php">Perfil</a>
    </div>
  </div>
</header>
  ...
  <div class="boxinfopaciente">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="rgCpfPaciente" name="rgCpfPaciente" placeholder="Digite..."
          oninput="validarNumeroRGCPFPaciente(this);">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="nomeAcompanhante" name="nomeAcompanhante" placeholder="Digite..."
          oninput="validarNomeAcomp(this); capitalizarPalavrasIniciais(this);">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="idadeAcompanhante" name="idadeAcompanhante" maxlength="3" placeholder="Digite..."
          oninput="validarNumeroIdadeAcomp(this)">
    ...
    <div class="grid_vitima">
      <div>
        <div class="checkbox">
          <input type="checkbox" name="ciclista" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
          <label for="ciclista">Ciclista</label>
        </div>
      </div>
      <div>
        <div class="checkbox">
          <input type="checkbox" name="CondutorMoto"  class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="Gestante" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="Pas.BancoFrente" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="Pas.Moto" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="CondutorCarro" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="clinico" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="trauma" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="Pas.BancoTras" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
      ...
      <div>
        <div class="checkbox">
          <input type="checkbox" name="Pedestre" class="selectCheckVitimaEra" id="selectCheckVitimaEra"
          onclick="selectCheckVitimaEra(this)">
  ...
  <div class="boxinfoocorrencia">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input class="textbox-n" placeholder="XX/XX/20XX" type="text" onfocus="(this.type='date')"
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="numocorrencia" name="numocorrencia" placeholder="Digite..."
          oninput="validarNumeroOcorr(this)">
    ...
    <div class="grid_ocorrencia">
      ...
      <div>
        <input type="checkbox" name="afogamento" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Afogamento">Afogamento</label>
      </div>
      <div>
        <input type="checkbox" name="agressao" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Agressão">Agressão</label>
      </div>
      <div>
        <input type="checkbox" name="atropelamento"class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Atropelamento">Atropelamento</label>
      </div>
      <div>
        <input type="checkbox" name="choqueElétrico" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Choque elétrico">Choque elétrico</label>
      </div>
      <div>
        <input type="checkbox" name="desabamento" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Desabamento">Desabamento</label>
      </div>
      <div>
        <input type="checkbox" name="domestico" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Doméstico">Doméstico</label>
      </div>
      <div>
        <input type="checkbox" name="esportivo" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Esportivo">Esportivo</label>
      </div>
      <div>
        <input type="checkbox" name="cCausadoPorAnimais" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="CausadoPorAnimais">Causado por animais</label>
      </div>
      <div>
        <input type="checkbox" name="ComMeioTransporte" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="ComMeioTransporte">Com meio de transp.</label>
      </div>
      <div>
        <input type="checkbox" name="Desmor./Desliz." class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Desmor./Desliz.">Desmor./Desliz.</label>
      </div>
      <div>
        <input type="checkbox" name="intoxicacao" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Intoxicação">Intoxicação</label>
      </div>
      <div>
        <input type="checkbox" name="quedabibicleta" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="QuedaBicicleta">Queda bicicleta</label>
      </div>
      <div>
        <input type="checkbox" name="quedamoto" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="QuedaMoto">Queda moto</label>
      </div>
      <div>
        <input type="checkbox" name="quedanivelmenor2m" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="QuedaNivelMenor2M"> Queda nível &gt; 2M </label>
      </div>
      <div>
        <input type="checkbox" name="trabalho" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Trabalho">Trabalho</label>
      </div>
      <div>
        <input type="checkbox" name="transferência" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="Transferência">Transferência</label>
      </div>
      <div>
        <input type="checkbox" name="emergênciamédica" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="EmergenciaMedica">Emergência Médica</label>
      </div>
      <div>
        <input type="checkbox" name="quedaalturamaior2m" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="QuedaAlturaMaior2M">Queda de altura &lt; 2M</label>
      </div>
      <div>
        <input type="checkbox" name="tentativasuicidio" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
        <label for="TentativadeSuicidio">Tentativa de suicídio</label>
      </div>
      <div>
        <input type="checkbox" name="quedaprorpiaaltura" class="selectCheckOcorrencia" id="selectCheckOcorrencia"
        onclick="selectCheckOcorrencia(this)">
    ...
    <div class="grid_cinematica">
      ...
      <div class="grid_checkbox_sim_cinematica">
        <div>
          <input type="checkbox" name="Sim" class="selectCheckDistúrbio" id="selectCheckDistúrbio"
            onclick="selectCheckDistúrbio(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckCapacete" id="selectCheckCapacete"
            onclick="selectCheckCapacete(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckCinto" id="selectCheckCinto"
            onclick="selectCheckCinto(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckParabrisa" id="selectCheckParabrisa"
            onclick="selectCheckParabrisa(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckCaminhando" id="selectCheckCaminhando"
            onclick="selectCheckCaminhando(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckPainel" id="selectCheckPainel"
            onclick="selectCheckPainel(this)">
          <label for="Sim">Sim</label>
        </div>
        <div>
          <input type="checkbox" name="Sim" class="selectCheckVolante" id="selectCheckVolante"
            onclick="selectCheckVolante(this)">
          <label for="Sim">Sim</label>
        </div>
      </div>
      ...
      <div class="grid_checkbox_nao_cinematica">
        <div>
          <input type="checkbox" name="Não" class="selectCheckDistúrbio" id="selectCheckDistúrbio"
            onclick="selectCheckDistúrbio(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckCapacete" id="selectCheckCapacete"
            onclick="selectCheckCapacete(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckCinto" id="selectCheckCinto"
            onclick="selectCheckCinto(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckParabrisa" id="selectCheckParabrisa"
            onclick="selectCheckParabrisa(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckCaminhando" id="selectCheckCaminhando"
            onclick="selectCheckCaminhando(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckPainel" id="selectCheckPainel"
            onclick="selectCheckPainel(this)">
          <label for="Não">Não</label>
        </div>
        <div>
          <input type="checkbox" name="Não" class="selectCheckVolante" id="selectCheckVolante"
            onclick="selectCheckVolante(this)">
          <label for="Não">Não</label>
        </div>
      </div>
  ...
  <div class="boxsituacaopaciente">
    ...
    <form class="form">
      ...
      <div class="checkbox-texto">
        <input type="checkbox" name="menor2seg" class="selectCheckPerfusaoMaiorDois" id="selectCheckPerfusaoMaiorDois1"
          onclick="selectCheckPerfusaoMaiorDois(this)">
        <label for="Menor2seg">&gt;2 SEG</label>

        <input type="checkbox" name="maior2seg" class="selectCheckPerfusaoMaiorDois" id="selectCheckPerfusaoMaiorDois2"
          onclick="selectCheckPerfusaoMaiorDois(this)">
      ...
      <div class="checkbox-texto">
        <input type="checkbox" id="selectCheckNormalAnormal1" name="normal" class="selectCheckNormalAnormal"
          onclick="selectCheckNormalAnormal(this)" />
        <label for="checkbox-id-1">NORMAL</label>


        <input type="checkbox" id="selectCheckNormalAnormal2" name="anormal" class="selectCheckNormalAnormal"
          onclick="selectCheckNormalAnormal(this)" />
      ...
      <div class="grid_maior5">
        ...
        <div class="check_ocular">
          ...
          <div class="checkbox">4
            <input type="checkbox" name="Maior5AberturOcularEspontânea" class="checkAberturaOcularMaior5" id="espontanea"
              onclick="selectAberturaOcularMaior5(this)">
            <label for="Espontânea">Espontânea</label>
            <div class="numeros_niveis"></div>
          </div>
          <div class="checkbox">3
            <input type="checkbox" name="Maior5AberturOcularComandoVerbal" class="checkAberturaOcularMaior5" id="comandoverbal"
              onclick="selectAberturaOcularMaior5(this)">
            <label for="ComandoVerbal">Comando verbal</label>
            <div class="numeros_niveis"></div>
          </div>
          <div class="checkbox">2
            <input type="checkbox" name="Maior5AberturOcularEstimuloDoloroso" class="checkAberturaOcularMaior5" id="estimulodoloroso"
              onclick="selectAberturaOcularMaior5(this)">
            <label for="EstímuloDoloroso">Estímulo doloroso</label>
            <div class="numeros_niveis"></div>
          </div>
          <div class="checkbox">1
            <input type="checkbox" name="Maior5AberturOcularNenhuma" class="checkAberturaOcularMaior5" id="nenhuma"
              onclick="selectAberturaOcularMaior5(this)">
            <label for="Nenhuma">Nenhuma</label>
            <div class="numeros_niveis"></div>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="Maior5AberturOcularNT" class="checkAberturaOcularMaior5" id="NT"
              onclick="selectAberturaOcularMaior5(this)">
      ...
      <div class="grid_maior5">
        ...
        <div class="check_ocular">
          ...
          <div class="checkbox">5
            <input type="checkbox" name="Maior5RespostaVerbalOrientado" class="checkRespostaVerbalMaior5" id="Orientado"
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="Orientado">Orientado</label>
          </div>
          <div class="checkbox">4
            <input type="checkbox" name="Maior5RespostaVerbalConfuso" class="checkRespostaVerbalMaior5" id="Confuso"
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="Confuso">Confuso</label>
          </div>
          <div class="checkbox">3
            <input type="checkbox" name="Maior5RespostaVerbalPalavrasInapro." class="checkRespostaVerbalMaior5" id="Palavras_Inapro."
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="PalavrasInapro.">Palavras Inapro.</label>
          </div>
          <div class="checkbox">2
            <input type="checkbox" name="Maior5RespostaPalavrasIncomp." class="checkRespostaVerbalMaior5" id="Palavras_Incomp."
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="PalavrasIncomp.">Palavras Incomp.</label>
          </div>
          <div class="checkbox">1
            <input type="checkbox" name="Maior5RespostaVerbalNenhuma" class="checkRespostaVerbalMaior5" id="Nenhuma"
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="Nenhuma">Nenhuma</label>
          </div>
          <div class="checkbox">
            <input type="checkbox" name="Maior5RespostaVerbalNT" class="checkRespostaVerbalMaior5" id="NT"
              onclick="selectRespostaVerbalMaior5(this)">
            <label for="NT">NT</label>
            <div class="numeros_niveis"></div>
          </div>
      ...
      <div class="grid_maior5">
        ...
        <div class="check_ocular">
          ...
          <div class="checkbox">6
            <input type="checkbox" name="Maior5RespostaMotoraObedeceComandos" class="checkRespostaMotoraMaior5" id="Obedece_comandos"
              onclick="selectRespostaMotoraMaior5(this)">
            <label for="ObedeceComandos">Obedece comandos</label>
          </div>
          <div class="checkbox">5
            <input type="checkbox" name="Maior5RespostaMotoraLocalizaDor" class="checkRespostaMotoraMaior5" id="Localiza_dor"
              onclick="selectRespostaMotoraMaior5(this)">
            <label for="LocalizaDor">Localiza dor</label>
          </div>
          <div class="checkbox">4
            <input type="checkbox" name="Maior5RespostaMotoraMov.Retirada" class="checkRespostaMotoraMaior5" id="Mov_retirada"
              onclick="selectRespostaMotoraMaior5(this)">
            <label for="Mov.deRetirada">Mov. de retirada</label>
          </div>
          <div class="checkbox">3
            <input type="checkbox" name="Maior5RespostaMotoraFlexaoNormal" class="checkRespostaMotoraMaior5" id="Flexão_anormal"
              onclick="selectRespostaMotoraMaior5(this)">
            <label for="FlexãoAnormal">Flexão anormal</label>
          </div>
          <div class="checkbox">2
            <input type="checkbox" name="Maior5RespostaMotoraExtensaoAnormal" class="checkRespostaMotoraMaior5" id="ExtensãoAnormal"
              onclick="selectRespostaMotoraMaior5(this)">
            ...
            <div class="checkbox">
              <input type="checkbox" name="Maior5RespostaMotoraNT" class="checkRespostaMotoraMaior5" id="NT"
                onclick="selectRespostaMotoraMaior5(this)">
              <label for="NT">NT</label>
              <div class="numeros_niveis"></div>
            </div>
    ...
    <div class="grid_maior5">
      ...
      <div class="check_ocular">
        <div class="checkbox-menor5-aberturaocular">4
          <input type="checkbox" name="checkBox[]" class="checkAberturaOcularMenor5" id="checkbox-id-1"
            onclick="selectAberturaOcularMenor5(this)">
    ...
    <div class="grid_maior5">
      ...
      <div class="check_ocular">
        ...
        <div class="checkbox-menor5-respostaverbal">5
          <input type="checkbox" name="checkBox[]" class="checkRespostaVerbalMenor5" id="checkbox-id-1"
            onclick="selectRespostaVerbalMenor5(this)">
    ...
    <div class="grid_maior5">
      ...
      <div class="check_ocular">
        ...
        <div class="checkbox-menor5-respostamotora">6
          <input type="checkbox" name="checkBox[]" class="checkRespostaMotoraMenor5" id="checkbox-id-1"
            onclick="selectRespostaMotoraMenor5(this)">
...
<div class="texto" id="localizacao-traumas">Queimaduras</div>
    ...
    <div class="grid_transporte">
      <div>
        <input type="checkbox" name="checkBox[]" class="selectCheckTransporte" id="selectCheckTransporte1"
          onclick="selectCheckTransporte(this)">
        <label for="checkbox-id-1">Ruim</label>
      </div>
      <div>
        <input type="checkbox" name="checkBox[]" class="selectCheckTransporte" id="selectCheckTransporte2"
          onclick="selectCheckTransporte(this)">
        <label for="checkbox-id-2">Péssimo</label>
      </div>
      <div>
        <input type="checkbox" name="checkBox[]" class="selectCheckTransporte" id="selectCheckTransporte3"
          onclick="selectCheckTransporte(this)">
        <label for="checkbox-id-3">Bom</label>
      </div>
      <div>
        <input type="checkbox" name="checkBox[]" class="selectCheckTransporte" id="selectCheckTransporte4"
          onclick="selectCheckTransporte(this)">
    ...
    <form class="form">
      ...
      <div class="grid_cinematica_aconteceu">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="AconteceuOutrasVezes" class="selectCheckAconteceuOutrasVezes" id="selectCheckAconteceuOutrasVezes1"
              onclick="selecionarCheckboxAconteceuOutrasVezes(this); habilitarContainerAconteceu(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckAconteceuOutrasVezes" id="selectCheckAconteceuOutrasVezes2"
              onclick="selecionarCheckboxAconteceuOutrasVezes(this); habilitarContainerAconteceu(this)">
      ...
      <div class="grid_cinematica_problemaSaude">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="ProblemaSaude" class="selectCheckProblemaSaude" id="selectCheckProblemaSaude1"
              onclick="selecionarCheckboxProblemaSaude(this); habilitarContainerPrbSaude(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="ProblemaSaude" class="selectCheckProblemaSaude" id="selectCheckProblemaSaude2"
              onclick="selectCheckProblemaSaude(this); habilitarContainerPrbSaude(this)">
...
<br>
      ...
      <div class="grid_cinematica_medicacao">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="Medicacao" class="selectCheckMedicacao" id="selectCheckMedicacao1"
              onclick="selecionarCheckboxMedicacao(this); habilitarContainerMedicacao(this); habilitarContainerMedicacaoQuais(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="Medicacao" class="selectCheckMedicacao" id="selectCheckMedicacao2"
              onclick="selecionarCheckboxMedicacao(this); habilitarContainerMedicacao(this); habilitarContainerMedicacaoQuais(this)">
      ...
      <div class="grid_cinematica_alergico">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="Alergico" class="selectCheckAlergico" id="selectCheckAlergico1"
              onclick="selecionarCheckboxAlergico(this); habilitarContainerAlergico(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="Alergico" class="selectCheckAlergico" id="selectCheckAlergico2"
              onclick="selecionarCheckboxAlergico(this); habilitarContainerAlergico(this)">
...
<br>
      ...
      <div class="grid_cinematica_alimento">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="alimento-check" class="selectCheckAlimento6horas" id="selectCheckAlimento6horas1"
              onclick="selectCheckAlimento6horas(this); habilitarContainerAlimento_espec(this); habilitarContainerAlimento_horas(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="alimento-check" class="selectCheckAlimento6horas" id="selectCheckAlimento6horas2"
              onclick="selectCheckAlimento6horas(this); habilitarContainerAlimento_espec(this); habilitarContainerAlimento_horas(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
...
<div class="gestacional hidden">
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckComplicacoes" id="selectCheckComplicacoes1"
            onclick="selectCheckComplicacoes(this)">
            <label for="checkbox-id-1">Sim</label>
          </div>
        </div>
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckComplicacoes" id="selectCheckComplicacoes2"
            onclick="selectCheckComplicacoes(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
      ...
      <div class="grid_cinematica_primeiro_filho">
        ...
        <div class="grid_checkbox_sim_cinematica">
            <div>
                <input type="checkbox" name="PrimeiroFilho" class="selectCheckPrimeiroFilho" id="selectCheckPrimeiroFilho1"
                    onclick="selecionarCheckboxPrimeiroFilho(this); habilitarContainerQuantos(this);">
        ...
        <div class="grid_checkbox_nao_cinematica">
            <div>
                <input type="checkbox" name="PrimeiroFilho" class="selectCheckPrimeiroFilho" id="selectCheckPrimeiroFilho2"
                    onclick="selecionarCheckboxPrimeiroFilho(this); habilitarContainerQuantos(this);">
    ...
    <form class="form">
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckPressaoEvacuar" id="selectCheckPressaoEvacuar1"
            onclick="selectCheckPressaoEvacuar(this)">
            <label for="checkbox-id-1">Sim</label>
          </div>
        </div>
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckPressaoEvacuar" id="selectCheckPressaoEvacuar2"
              onclick="selectCheckPressaoEvacuar(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckRupturaBolsa" id="selectCheckRupturaBolsa1"
              onclick="selectCheckRupturaBolsa(this)">
            <label for="checkbox-id-1">Sim</label>
          </div>
        </div>
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckRupturaBolsa" id="selectCheckRupturaBolsa2"
              onclick="selectCheckRupturaBolsa(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckInspecaoVisual" id="selectCheckInspecaoVisual1"
            onclick="selectCheckInspecaoVisual(this)">
            <label for="checkbox-id-1">Sim</label>
          </div>
        </div>
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckInspecaoVisual" id="selectCheckInspecaoVisual2"
              onclick="selectCheckInspecaoVisual(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckPartoRealizado" id="selectCheckPartoRealizado1"
            onclick="selectCheckPartoRealizado(this)">
            <label for="checkbox-id-1">Sim</label>
          </div>
        </div>
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckPartoRealizado" id="selectCheckPartoRealizado2"
            onclick="selectCheckPartoRealizado(this)">
            <label for="checkbox-id-8">Não</label>
          </div>
        </div>
      ...
      <div class="grid_cinematica">
        ...
        <div class="grid_checkbox_sim_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckSexoBebe" id="selectCheckSexoBebe1"
            onclick="selectCheckSexoBebe(this)">
        ...
        <div class="grid_checkbox_nao_cinematica">
          <div>
            <input type="checkbox" name="checkBox[]" class="selectCheckSexoBebe" id="selectCheckSexoBebe2"
            onclick="selectCheckSexoBebe(this)">
  ...
  <div class="boxatendimento">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="username" name="username"
          oninput="validarAtendimentoM(this); capitalizarPalavrasIniciais(this);" placeholder="Digite...">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="username" name="username"
          oninput="validarS1(this); capitalizarPalavrasIniciais(this);" placeholder="Digite...">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="username" name="username"
          oninput="validarS2(this); capitalizarPalavrasIniciais(this);" placeholder="Digite...">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="username" name="username"
          oninput="validarS3(this); capitalizarPalavrasIniciais(this);" placeholder="Digite...">
    ...
    <form class="form">
      <div class="input-caixatexto">
        ...
        <input type="text" id="username" name="username"
          oninput="validarDemandante(this); capitalizarPalavrasIniciais(this);" placeholder="Digite...">
    ...
    <div class="grid_procedimentos">
      ...
      <div>
          <label class="item">
            <input type="checkbox" class="main-checkbox-atadura" id="atadura" onclick="toggleInputQuantidadeAtadura()"; 
            onchange="toggleAtadura()" > ATADURA</label><br>
    ...
    <div class="inputquantidade">
      ...
      <div>
      <label class="item">
        <input type="checkbox" class="main-checkbox-kits" id="kits" onclick="toggleInputQuantidadeKits()"; 
        onchange="toggleKits()"> KIT'S</label><br>
    ...
    <div class="inputquantidade">
      ...
      <div>
        <label class="item">
          <input type="checkbox" class="main-checkbox-talas" id="talas" onclick="toggleInputQuantidadeTalas()"; 
            onchange="toggleTalas()"> TALAS PAP.</label><br>
    ...
    <div class="inputquantidade">
      ...
      <div>
        <label class="item">
          <input type="checkbox" class="main-checkbox-colar" id="colar" onclick="toggleInputQuantidadeColar()"; 
          onchange="toggleColar()"> COLAR</label><br>
    ...
    <div class="inputquantidade">
      ...
      <div>
        <label class="item">
          <input type="checkbox" class="main-checkbox-ked" id="ked" onclick="toggleInputQuantidadeKed()"; 
          onchange="toggleKed()"> KED</label><br>
    ...
    <div class="inputquantidade">
      ...
      <div>
        <label class="item">
          <input type="checkbox" class="main-checkbox-ttf" id="ttf" onclick="toggleInputQuantidadeTtf()"; 
          onchange="togglettf()"> T.T.F.</label><br>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.10/jspdf.plugin.autotable.min.js"></script>
  ...
  <sc<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
