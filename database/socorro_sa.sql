...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/11/2023 às 03:56
...
(1, 'Celo', '12121212121', 'celo@geradornv.com.br', 'celo123', '2023-10-18 14:03:08', 'Administrador'),
...
--
ALTER TABLE `atendente`
  MODIFY `id_atendente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
